...
import com.superiorshoes.ooguro.androidsuperiorserver.Service.ListenOrder;
import com.superiorshoes.ooguro.androidsuperiorserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    newCategory = new Category(ssName.getText().toString(),uri.toString());
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                         // Send Category Id and starts new activity
                        Intent clothList = new Intent(Home.this,ClothList.class);
    ...
    private void DeleteCategory(String key) {
        ...
        // Adds all cloth to category
        DatabaseReference cloths = database.getReference("Cloths");
        Query clothInCategory = cloths.orderByChild("menuId").equalTo(key);
        clothInCategory.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
